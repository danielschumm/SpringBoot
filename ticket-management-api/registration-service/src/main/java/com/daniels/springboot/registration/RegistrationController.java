package com.daniels.springboot.registration;

import com.daniels.springboot.events.Event;
import com.daniels.springboot.events.EventsClient;
import com.daniels.springboot.events.Product;
...
public class RegistrationController {
    ...
    @PostMapping
    public Registration create(@RequestBody Registration registration, HttpServletRequest request) {
